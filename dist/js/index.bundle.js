...
function () {
  ...
  KonvaBase.prototype.Init_container = function (selector) {
    ...
    if (this.container == null || this.container == undefined) throw new Error('[' + this.constructor.name + ' CheckSelector] 無法取得容器: ' + selector);else if (this.container.tagName != 'DIV') throw new Error('[' + this.constructor.name + ' CheckSelector] 容器必須為DIV');
  };
  /**
   * 初始化-場景
   * @private
  ...
  KonvaBase.prototype.Init_stage = function () {
    var containerStyle = getComputedStyle(this.container); //取得外部css樣式
